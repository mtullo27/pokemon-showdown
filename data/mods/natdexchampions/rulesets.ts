export const Rulesets: import('../../../sim/dex-formats').ModdedFormatDataTable = {
	standardag: {
		...
		ruleset: [
			...
			'Species Clause', 'Min Team Size = 6',
		],
	},
	standard: {
		inherit: true,
	...
	flatrules: {
		inherit: true,
		desc: "The in-game Flat Rules: Species Clause, -Mythical, -Restricted Legendary, Bring 6 Pick 3-6 depending on game type.",
		ruleset: ['Obtainable', 'Team Preview', 'Species Clause', 'Nickname Clause', 'Picked Team Size = Auto', 'Min Team Size = 6', 'Cancel Mod'],
